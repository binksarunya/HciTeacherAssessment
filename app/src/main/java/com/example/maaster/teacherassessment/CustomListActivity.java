...
public class CustomListActivity extends ArrayAdapter<String>{
    ...
    public CustomListActivity(Activity context,
                              ArrayList<Teacher> teachers, String[] name, String[] course, String[] section, Student student, HashMap<String,ArrayList<Question>> teacherresult,ArrayList<Course> courses, boolean check ,boolean dialogCheck) {
    ...
    public void showResultAssess(HashMap<String,ArrayList<Question>> teacherresult,int position) {
        ...
        EditAssesListActivity adapter = new EditAssesListActivity(context,answerLsit,teacherresult.get(String.valueOf(position)));
